...
public class ArchitectCupPhase4Pool : TypeListCardPoolModel
{
    public override string Title => "ArchitectCupPhase4";
...
#pragma warning disable CS0618
    ...
    protected override IEnumerable<Type> CardTypes => ArchitectCupCardCatalog.All
        .Where(static definition => definition.Phase == 4 && definition.ShowInCompendium)
